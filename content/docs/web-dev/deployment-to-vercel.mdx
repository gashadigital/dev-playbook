...
<Steps>
  ...
  <Step>
    ### Build Test
    Run `npm run build` locally. If it fails here, it will fail on Vercel.
  </Step>
  <Step>
    ### Branch Health
...
|-------|--------------|-----|
| **Build Failed** | Type errors or missing dependencies | Run `npm run build` locally and fix all linting/TS errors |
